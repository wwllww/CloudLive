...
typedef struct VideoSettingParam
{
	bool      bChange;
	UINT      AdpterID;
	UINT      FPS;
...
typedef struct AudioSettingParam
{
	bool      bChange;
...
{
	EncoderParam          Encoder;
	LiveSettingParam      LiveSetting;
	VideoSettingParam     VideoSetting;
	AudioSettingParam     AudioSetting;
...
extern "C" {
	...
	API_EXPORT int SLiveUpdateStreamPosition(uint64_t iIntanceID, uint64_t iStreamID, VideoArea *Area);
	...
	API_EXPORT int SLiveStartLive(uint64_t iIntanceID,const char *cJsonArryURL, bool bRecord = true);
