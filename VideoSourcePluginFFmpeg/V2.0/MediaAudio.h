...
public:
	...
	~CDemandMediaAudio();
public:
	virtual bool GetNextBuffer(void **buffer, UINT *numFrames, QWORD *timestamp, bool bLiveGet);
	...
	virtual bool IsLiveInstance() const;
