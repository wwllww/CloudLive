...
public:
	...
	void ClearAudio();
	void FindDifAudioWithInstance(CInstanceProcess *Other);
	void RemveDifAudio();
	UINT GetRenderCount();
	...
	void DrawLittlePreview(Shader *MainVertShader, Shader* MainPixShader, Texture *SDITexture);
...
private:
	...
	HANDLE              m_hMutexRawV;
	bool                bHasAudio;
	std::list<IBaseAudio*> m_DifAudioList;
};
