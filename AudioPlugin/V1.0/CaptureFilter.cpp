...
CapturePin::CapturePin(CaptureFilter* filterIn, DSource *sourceIn, const GUID &expectedMajorType, const GUID &expectedMediaType)
...
CaptureFilter::CaptureFilter(DSource *source, const GUID &expectedMajorType, const GUID &expectedMediaType)
