...
public:
	CapturePin(CaptureFilter *filter, PCMRecord *source, const GUID &expectedMajorType, const GUID &expectedMediaType);
    virtual ~CapturePin();
...
public:
    CaptureFilter(PCMRecord *source, const GUID &expectedMajorType, const GUID &expectedMediaType);
