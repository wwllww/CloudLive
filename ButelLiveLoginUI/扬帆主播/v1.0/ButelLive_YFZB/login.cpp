    ...
    ui(new Ui::LoginUI)
{
    ...
    int ret = BLiveAppInit(ConfigOper::instance()->m_StrUrl.toLocal8Bit().data(),ConfigOper::instance()->m_UpLoadUrl.toLocal8Bit().data(),ConfigOper::instance()->m_UpLoadAppId.toLocal8Bit().data());
}
