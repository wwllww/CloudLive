...
Texture* D3D10Texture::CreateTextureFromFile(CTSTR lpFile, BOOL bBuildMipMaps,UINT &Width, UINT& Height)
{
    HRESULT err;
...
Texture* D3D10Texture::CreateTextureRead(unsigned int width, unsigned int height)
{
	HRESULT err;
