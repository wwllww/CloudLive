...
==========================================================*/
 ...
 Quat CubicInterpolateQuat(const Quat &prev, const Quat &from, const Quat &to, const Quat &after, float t);

 Vect GetHSpline(const Vect &v0, const Vect &v1, const Vect &m0, const Vect &m1, float fT);

 BOOL SphereRayCollision(const Vect &sphereCenter, float sphereRadius, const Vect &rayOrig, const Vect &rayDir, Vect *collision=NULL, Plane *collisionPlane=NULL);
 BOOL CylinderRayCollision(const Vect &cylCenter, float cylRadius, float cylHeight, const Vect &rayOrig, const Vect &rayDir, Vect *collision=NULL, Plane *collisionPlane=NULL);
...
inline Quat  Quat::operator*(const AxisAngle &aa) const {return Quat(*this) *= aa.GetQuat();}
 ...
 float RandomFloat(BOOL bPositiveOnly=FALSE);
 Vect  RandomVect(BOOL bPositiveOnly=FALSE);
...
inline BOOL PointInsideTri(const Vect2 &v1, const Vect2 &v2, const Vect2 &v3, const Vect2 &p)
{
 ...
 void Matrix4x4Convert(float *destMat4x4, const Matrix &matSource);
 void Matrix4x4Convert(Matrix &destMat3x4, float *matSource);
 void Matrix4x4Multiply(float *destMatrix, float *M1, float *M2);
 void Matrix4x4TransformVect(Vect4 &out, float *M1, const Vect4 &vec);
