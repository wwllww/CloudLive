...
CapturePin::CapturePin(CaptureFilter* filterIn, PCMRecord *sourceIn, const GUID &expectedMajorType, const GUID &expectedMediaType)
...
CaptureFilter::CaptureFilter(PCMRecord *source, const GUID &expectedMajorType, const GUID &expectedMediaType)
