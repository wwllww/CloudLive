...
public:
    CapturePin(CaptureFilter *filter, DSource *source, const GUID &expectedMajorType, const GUID &expectedMediaType);
    virtual ~CapturePin();
...
public:
    CaptureFilter(DSource *source, const GUID &expectedMajorType, const GUID &expectedMediaType);
