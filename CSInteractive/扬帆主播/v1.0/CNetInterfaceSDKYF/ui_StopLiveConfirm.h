...
public:
    ...
    void setupUi(QDialog *StopLiveConfirmUI)
    {
        ...
        StopLiveConfirmUI->resize(671, 140);
...
"border-image: url(:/images/xxx_bg.png);"));
        ...
        sizePolicy2.setHeightForWidth(m_pRdBtnTemp->sizePolicy().hasHeightForWidth());
        m_pRdBtnTemp->setSizePolicy(sizePolicy2);
        m_pRdBtnTemp->setStyleSheet(QStringLiteral("color: rgb(255, 255, 0);"));
        m_pRdBtnTemp->setChecked(false);

        gridLayout->addWidget(m_pRdBtnTemp, 1, 0, 1, 1);
...
"border-image: url(:/images/btn_back.png);"));
        ...
        m_pRdBtnClose->setEnabled(true);
        sizePolicy2.setHeightForWidth(m_pRdBtnClose->sizePolicy().hasHeightForWidth());
        m_pRdBtnClose->setSizePolicy(sizePolicy2);
        m_pRdBtnClose->setStyleSheet(QStringLiteral("color: rgb(255, 0, 0);"));
        m_pRdBtnClose->setCheckable(true);
        m_pRdBtnClose->setChecked(true);

        gridLayout->addWidget(m_pRdBtnClose, 0, 0, 1, 1);
