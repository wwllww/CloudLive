...
class DebugAlloc : public FastAlloc
{
    HANDLE hDebugMutex;
...
void EnableMemoryTracking(BOOL bEnable, int id=0);
void SetMemoryBreakID(int id);


//goes to malloc/realloc/free
class DefaultAlloc : public Alloc
{
public:
    virtual void * __restrict _Allocate(size_t dwSize);
...
class SeriousMemoryDebuggingAlloc : public DefaultAlloc
{
public:
