...
public:
    ...
    inline void ReadFileToString(String &strIn)
    {
		...
		LPSTR lpFileDataUTF8 = (LPSTR)Allocate_Bak(dwFileSize + 1);
 ...
 String GetPathFileName(CTSTR lpPath, BOOL bExtention=FALSE);
...
class  XFileInputSerializer : public Serializer
{
public:
...
public:
    ...
    BOOL Open(CTSTR lpFile, DWORD dwCreationDisposition, DWORD bufferSize=(1024*64))
    {
		...
		Buffer = (LPBYTE)Allocate_Bak(bufferSize);
