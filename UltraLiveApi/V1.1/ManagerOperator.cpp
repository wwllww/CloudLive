...
// 		baseCY = BSParam.LiveSetting.Height;
	...
	if (!MixRenderTarget)
	{
		Log::writeError(LOG_RTSPSERV, 1, "MixRenderTarget ¥¥Ω® ß∞‹");
	}
	...
	if (!MixCopyTexture)
	{
		Log::writeError(LOG_RTSPSERV, 1, "MixCopyTexture ¥¥Ω® ß∞‹");
	}
	...
	{
		Log::writeError(LOG_RTSPSERV, 1, "MixyuvRenderTexture ¥¥Ω® ß∞‹");
	}
